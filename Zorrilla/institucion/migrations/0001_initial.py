    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_nacimiento_t', models.DateTimeField(blank=True, verbose_name='Fecha Nacimiento')),
                ...
                ('fecha_inicio_actividad', models.DateTimeField(verbose_name='Fecha de Inicio de Clases en el Colegio')),
                ('antecedentes_laborales', models.TextField(max_length=300, verbose_name='Datos de Trabajos Previos')),
                ('antiguedad_en_empresa', models.DateTimeField(verbose_name='Antiguedad en la Empresa')),
