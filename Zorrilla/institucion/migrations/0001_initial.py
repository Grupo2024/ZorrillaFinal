# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2018-08-02 14:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seccion', models.BooleanField(verbose_name='True = A o C, dependiendo de si es ma\xf1ana o tarde')),
            ],
        ),
        migrations.CreateModel(
            name='Profesor',
        ...
        migrations.AddField(
            ...
            name='grado',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='institucion.Grado'),
        ),
        migrations.AddField(
            model_name='asignacion',
            name='prof_asignado',
