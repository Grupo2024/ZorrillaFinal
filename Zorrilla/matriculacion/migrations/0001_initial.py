...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('alumnx', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='matriculacion.Alumno')),
                ('transportistx', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='matriculacion.Transportista')),
            ],
        ),
        migrations.AddField(
            model_name='alumno',
        ...
        migrations.AddField(
            model_name='alumno',
            name='curso',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='institucion.Curso'),
        ),
        migrations.AddField(
            model_name='alumno',
            name='padres',
